...
LANGUAGE_FEATURES_DB: Dict[ProgrammingLanguage, LanguageFeatures] = {
    ProgrammingLanguage.CPP: LanguageFeatures(
        ...
        best_practices=[
            ...
            "CRITICAL: Use ONLY C++17 STL - NO third-party libraries (no OpenSSL, no Boost, no external dependencies)",
            "For hashing: use std::hash or implement simple hash functions with STL only",
            "For crypto: implement simple algorithms with STL (std::random_device, std::mt19937, bitwise operations)",
        ],
